...
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template?>/css/<?php echo $menu_color; ?>.css" rel="stylesheet" type="text/css" />
...
<style type="text/css">
	...
	#right-column { width:<?php echo $rightcolumn_width; ?>px;padding:0;}
